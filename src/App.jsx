...
export default function App() {
  ...
  return (
    <div style={{ fontFamily:"'Segoe UI',system-ui,sans-serif" }}>
      ...
      {screen === "moduleselect"&& <ModuleSelect xp={xp} onSelect={m => { setModule(m); setScreen("levelmap"); }} />}
      {screen === "levelmap"    && module && (
        <LevelMap
          module={module} xp={xp} completed={completed} maxPlayable={MAX_PLAYABLE_LEVEL}
